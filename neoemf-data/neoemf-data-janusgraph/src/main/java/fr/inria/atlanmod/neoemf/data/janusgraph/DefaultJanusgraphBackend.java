...
/**
 * The default {@link JanusgraphBackend} mapping.
 *
 * @see JanusgraphBackendFactory
 */
@ParametersAreNonnullByDefault
class DefaultJanusgraphBackend extends AbstractJanusgraphBackend {

    /**
     * Constructs a new {@code DefaultJanusgraphBackend}.
     *
     * @see JanusgraphBackendFactory
     */
    protected DefaultJanusgraphBackend() {
        super();
